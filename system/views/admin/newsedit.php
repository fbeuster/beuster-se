    ...
    <form action="/newsedit" method="post" enctype="multipart/form-data" class="userform articleform">
      <fieldset>
        ...
        <label class="required long <?php if(isset($data['errors']['title'])) { echo ' has_error'; } ?>">
          <span><?php I18n::e('admin.article.edit.title.label'); ?></span>
          <input type="text" name="title" value="<?php if (isset($data['values'], $data['values']['title'])) { echo $data['values']['title']; } ?>" role="newEntryTitle" placeholder="<?php I18n::e('admin.article.edit.title.placeholder'); ?>">
        </label>
        ...
        <label class="<?php if(isset($data['errors']['release_date'])) { echo ' has_error'; } ?>">
          <span>
            <?php I18n::e('admin.article.edit.release_date.label'); ?>
          </span>
          <input type="date" name="release_date" value="<?php if(isset($data['values']['release_date'])) echo $data['values']['release_date']; ?>" placeholder="<?php I18n::e('admin.article.edit.release_date.placeholder'); ?>">
        </label>

        <label class="<?php if(isset($data['errors']['release_time'])) { echo ' has_error'; } ?>">
          <span>
            <?php I18n::e('admin.article.edit.release_time.label'); ?>
          </span>
          <input type="time" name="release_time" value="<?php if(isset($data['values']['release_time'])) echo $data['values']['release_time']; ?>" placeholder="<?php I18n::e('admin.article.edit.release_time.placeholder'); ?>">
        </label>
        ...
        <label class="required <?php if(isset($data['errors']['category'])) { echo ' has_error'; } ?>">
          ...
          <select name="category" class="catSelect" autocomplete="off">
            <option value="error">
              <?php I18n::e('admin.article.edit.category.placeholder'); ?>
            </option>
            <?php foreach($data['categories'] as $category) {
                    if(!$data['values']['is_playlist'] && $data['values']['category'] == $category) {
                      $selected = ' selected="selected"';
                    } else {
                      $selected = '';
                    } ?>
              <option <?php echo 'value="'.$category.'"'.$selected; ?>>
                <?php echo $category; ?>
              </option>
            <?php } ?>
          </select>
        ...
        <label class="<?php if(isset($data['errors']['category_new']) || isset($data['errors']['category_parent'])) { echo ' has_error'; } ?>">
          ...
          <select name="category_parent" autocomplete="off">
            ...
            <?php foreach($data['parents'] as $parent) {
              ...
              <option <?php echo 'value="'.$parent.'"'.$selected; ?>>
                <?php echo $parent; ?>
              </option>
            <?php } ?>
          </select>
          <input type="text" name="category_new" placeholder="<?php I18n::e('admin.article.edit.new_category.placeholder_input'); ?>" title="<?php I18n::e('admin.article.edit.new_category.placeholder_input'); ?>" value="<?php if(isset($data['values']['category_new'])) echo $data['values']['category_new']; ?>">
        </label>
        ...
        <label class="<?php if(isset($data['errors']['playlist'])) { echo ' has_error'; } ?>">
          ...
          <select name="playlist" autocomplete="off">
            <option value="error">
              <?php I18n::e('admin.article.edit.playlist.placeholder'); ?>
            </option>
            <?php foreach($data['playlists'] as $playlist) {
                    if($data['values']['is_playlist'] && $data['values']['category'] == $playlist) {
                      $selected = ' selected="selected"';
                    } else {
                      $selected = '';
                    } ?>
            <option <?php echo 'value="'.$playlist.'"'.$selected.'>'.$playlist; ?></option>
            <?php } ?>
          </select>
        </label>
        ...
        <label class="<?php if(isset($data['errors']['playlist_new']) || isset($data['errors']['laylist_new_id'])) { echo ' has_error'; } ?>">
          ...
          <input type="text" name="playlist_new" placeholder="<?php I18n::e('admin.article.edit.new_playlist.placeholder_name'); ?>" title="<?php I18n::e('admin.article.edit.new_playlist.placeholder_name'); ?>" value="<?php if(isset($data['values']['playlist_new'])) echo $data['values']['playlist_new']; ?>">

          <input type="text" name="playlist_new_id" placeholder="<?php I18n::e('admin.article.edit.new_playlist.placeholder_id'); ?>" title="<?php I18n::e('admin.article.edit.new_playlist.placeholder_id'); ?>" value="<?php if(isset($data['values']['playlist_new_id'])) echo $data['values']['playlist_new_id']; ?>">
        </label>

        <label class="long required <?php if(isset($data['errors']['tags'])) { echo ' has_error'; } ?>">
          <span>
            <?php I18n::e('admin.article.edit.tags.label'); ?>
          </span>
          <input type="text" name="tags" title="<?php I18n::e('admin.article.edit.tags.placeholder'); ?>" value="<?php if (isset($data['values']['tags'])) echo $data['values']['tags']; ?>" role="newEntryTags" placeholder="<?php I18n::e('admin.article.edit.tags.placeholder'); ?>">
        </label>
        ...
        <label<?php if(isset($data['errors']['thumbnail'])) { echo ' class="has_error"'; } ?>>
          ...
          <input type="text" name="thumbnail" placeholder="<?php I18n::e('admin.article.edit.thumbnail.placeholder'); ?>" value="<?php if (isset($data['values']['thumbnail'])) echo $data['values']['thumbnail']; ?>">
        </label>
