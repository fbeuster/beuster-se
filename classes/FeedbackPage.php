...
class FeedbackPage extends Page {
  ...
  public function __construct($url) {
    ...
    if ($this->hadData()) {
      $this->errors = array();
      $this->values = array(
        self::NAME_MAIL     =>                trim( $_POST[self::NAME_MAIL]     ),
        self::NAME_MESSAGE  => htmlentities(  trim( $_POST[self::NAME_MESSAGE]  ) ),
        self::NAME_NAME     => htmlentities(  trim( $_POST[self::NAME_NAME]     ) ),
        self::NAME_PAGE     => htmlentities(  trim( $_POST[self::NAME_PAGE]     ) ),
      );
      $this->validate();
