...
<article>
  <section>
    ...
    <?php if ($page->isNotificationDisablePage() && $page->sentByGet()) { ?>
      ...
      <?php } else { ?>
      <form action="<?php echo $page->getLink(); ?>" method="post">
        <fieldset>
          <legend>
          ...
          <ul>
            ...
            <li class="<?php echo $classes; ?>">
              <span><?php echo $comment->getAuthor()->getName(); ?></span>
              <span><?php echo $comment->getContentParsed(); ?></span>
            </li>
            <?php
            ...
            ?>
            <li class="<?php echo $classes; ?>">
              <span><?php echo $reply->getAuthor()->getName(); ?></span>
              <span><?php echo $reply->getContentParsed(); ?></span>
            </li>
            <?php } ?>
          </ul>
          <label>
